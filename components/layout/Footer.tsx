    ...
    <footer className={styles.footer}>
      <div className="container">
        <div className={styles.grid}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.about}>
              ...
              unforgettable journeys with full transparency and personal care.
            </p>
            <div className={styles.socials}>
              <a href="https://www.instagram.com/vmfholidays/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/vmfholidays/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://wa.me/917499322412" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.colLinks}>
              ...
              <li><Link href="/tools">Travel Tools</Link></li>
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.contact}>
              <li className={styles.office}>Goa (Head Office)</li>
              <li>
              ...
              <li>
                <span className={styles.contactIcon}>📞</span>
                <a href="tel:+919270354828">+91 92703 54828</a>
              </li>
              <li>
                <span className={styles.contactIcon}>📍</span>
                <a href="https://share.google/JzfZWjKoLzgoGPnjR" target="_blank" rel="noopener noreferrer">
                  Mendes Vaddo, H. No 128/3/A, Nagoa, Bardez, Goa 403516
                </a>
              </li>
              <li className={styles.office}>Mangalore (Branch)</li>
              <li>
                <span className={styles.contactIcon}>📞</span>
        ...
        <div className={styles.bottom}>
          <p>© {new Date().getFullYear()} VMF Holidays Pvt. Ltd. All rights reserved.</p>
