...
const ACTION_META: Record<string, { label: string; glyph: string; cat: Category }> = {
  ...
  "geography.create": { label: "Created a country", glyph: "✦", cat: "content" },
  "geography.update": { label: "Updated a country", glyph: "✎", cat: "content" },
  "geography.delete": { label: "Deleted a country", glyph: "✕", cat: "content" },
