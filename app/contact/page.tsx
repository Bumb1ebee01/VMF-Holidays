      ...
      <div className={`container ${styles.layout}`}>
        ...
        <aside className={styles.details}>
          <div className={styles.detailCard}>
            ...
            <div className={styles.detailItem}>
              ...
              <div>
                ...
                <p className={styles.detailValue}>H.No 128/3/A Mendes Waddo,<br />Nagoa, Bardez, Goa 403516</p>
              </div>
            </div>
          ...
          <div className={styles.mapWrap}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3843.2!2d73.8!3d15.55!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTXCsDMzJzAwLjAiTiA3M8KwNDgnMDAuMCJF!5e0!3m2!1sen!2sin!4v1234567890"
              width="100%"
              height="240"
              style={{ border: 0 }}
              allowFullScreen
