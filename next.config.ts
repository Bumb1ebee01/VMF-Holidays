...
//   - challenges.cloudflare.com … Cloudflare Turnstile (loads only if
//     NEXT_PUBLIC_TURNSTILE_SITE_KEY is set — see components/ui/Turnstile.tsx)
const csp = [
  `default-src 'self'`,
  `script-src 'self' 'unsafe-inline' https://unpkg.com https://www.googletagmanager.com https://challenges.cloudflare.com${isDev ? " 'unsafe-eval'" : ""}`,
  `style-src 'self' 'unsafe-inline' https://unpkg.com`,
  `img-src 'self' data: blob: https://res.cloudinary.com https://images.unsplash.com https://upload.wikimedia.org https://*.tile.openstreetmap.org https://unpkg.com https://www.googletagmanager.com https://*.google-analytics.com https://i.ytimg.com`,
  `font-src 'self'`,
